...
public class ProviderJelo {
    ...
    public static List<Jelo> getJela() {
        ...
        jela.add(new Jelo(1, "cezar.jpg", "Cezar salata 400g", "Obrok salata od svezeg povrca i mesa", "Paradajiz, krastavac, pilece meso, dresing i hleb u kockicama.", 210.00, 350.00, mrsnoJelo));
